...
class VideoComponentPage(VideoPage):
    ...
    def create_video(self):
        ...
        xblock_component_type_selector = 'li.component:nth-child(2) .xblock'
        new_xblock_component_type = self.q(css=xblock_component_type_selector).attrs('data-block-type')[0]

        if xblock_components_after == 2 and new_xblock_component_type == 'video':
            return True
        return False
